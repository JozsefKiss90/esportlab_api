...
# Create table
fig, ax = plt.subplots()
table = ax.table(cellText=table_data, loc='center', cellLoc='center', colWidths=[0.2, 0.1, 0.1, 0.1, 0.1])

# Color the cells
colors = [['#212946', '#212946', '#212946', '#212946', '#212946'],
          ['#212946', '#212946', '#212946', '#212946', '#212946'],
          ['#212946', '#212946', '#212946', '#212946', '#212946'],
         ]
